...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam9obmNvbnN0YW50IiwiYSI6ImNrb2x5cGtwZDB4emYydnFmaTk4bnhrNXcifQ.Hur0x9nZYH5a_plTIR0z0w';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/users/update-my-password' : 'http://127.0.0.1:8000/api/v1/users/update-my-account';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully")); //   setTimeout(() => {
